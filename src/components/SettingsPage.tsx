...
function WorkspaceSection() {
  ...
  return (
    <div className="space-y-5">
      ...
      <p className="text-[11px] text-ink-ghost leading-relaxed">Switching does not move existing files. Your flows load from the new location next.</p>
    </div>
  );
}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg border border-wire text-ink-dim text-[12px] font-medium hover:text-ink hover:border-wire-lit transition-all"
